...
function PopoverPanel({ anchorRef, popoverRef, children }: { anchorRef: React.RefObject<HTMLElement | null>; popoverRef: React.RefObject<HTMLDivElement | null>; children: ReactNode }) {
  ...
  return (
    <div
      ref={popoverRef}
      className="fixed z-[40000] inline-flex max-w-[min(380px,calc(100vw-16px))] flex-col items-start gap-3 rounded-lg border border-border bg-card p-3 shadow-lg [&_[data-filter-label]]:whitespace-nowrap"
